---
title: "Lateralization of visual system connectivity"
...
source(here::here("functions","lateralization_of_visual_connectivity_functions.R" ))
```
...
```
To quantify the lateralization of connectivty, we compute a laterality index latIndex as $$latIndex=\frac{Ipsi}{Ipsi+Contra}$$.
